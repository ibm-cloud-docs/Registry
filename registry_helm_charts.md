...
You can pull (download) a chart from any private or public [registry](#x2064940){: term} source or Helm repository to your computer, and then tag it for later use in {{site.data.keyword.registrylong_notm}}.

![Pull a chart from a private or public registry or Helm repository to your computer.](images/pulling_images_mul.svg "The following diagram shows that you can pull a chart from Container Registry or from any private or public registry source, or from a Helm repository to your local computer."){: caption="Pull charts from another registry" caption-side="bottom"}{: external download="../images/pulling_images_mul.svg"}
...
You can push (upload) a chart from your computer to your namespace in {{site.data.keyword.registrylong_notm}} to store your chart and share it with other users.

![Push a chart from your computer to {{site.data.keyword.registrylong_notm}}.](images/pushing_images_mul.svg "The following diagram shows that you can push a chart from your local computer to your namespace in Container Registry to store and share your chart with other users."){: caption="Push charts to your namespace" caption-side="bottom"}{: external download="../images/pushing_images_mul.svg"}
...
![Copying charts between registries.](images/copying_images_mul.svg "The following diagram shows that you can copy charts between registries by pulling a chart from a registry in one region and pushing it to a registry in another region."){: caption="Copying charts between registries" caption-side="bottom"}{: external download="../images/copying_images_mul.svg"}
