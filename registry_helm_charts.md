...
![Copying charts between registries.](images/copying_images_mul.svg "You can pull a chart from a registry in one region and push it to a registry in another region."){: caption="Figure 3. Copying charts between registries" caption-side="bottom"}
