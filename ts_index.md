...
# {{site.data.keyword.registrylong_notm}} troubleshooting
{: #ts_index}
...
-   If you are recreating a namespace that was deleted, and it contained many images, try again later.
...
-   [Verify that Docker is installed on your machine](registry_setup_cli_namespace.html#registry_cli_install).
...
-   [Review your {{site.data.keyword.registrylong_notm}} storage and pull traffic quota limits and usage](registry_quota.html#registry_quota_get).
...
1.  Note the public IP address of the machine that you want to use to connect to {{site.data.keyword.registrylong_notm}}. If you are using Kubernetes, use the public IP address of your worker node. Retrieve the public IP address of your worker node by running bx cs workers &lt;cluster_name_or_id&gt;.
