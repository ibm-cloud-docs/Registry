...
1. [Install the `container-registry` CLI plug-in.](/docs/services/Registry?topic=registry-index#registry_cli_install)
...
- [Install the {{site.data.keyword.Bluemix_notm}} CLI and the `container-registry` CLI plug-in](/docs/services/Registry?topic=registry-index#registry_cli_install).
...
Create a namespace, see [Set up a namespace](/docs/services/Registry?topic=registry-index#registry_namespace_add) in the Getting Started documentation.
