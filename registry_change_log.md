...
Version 1.3.19 of the CLI was released on 13 February 2026.
...
Version 1.3.18 of the CLI was released on 20 January 2026.
...
Version 1.3.16 of the CLI was released on 13 August 2025.

This release has the following changes:

- Correction to the information displayed for the `ibmcloud cr info` command.

## Version 1.3.15
{: #cli-change-logv1-1315}

Version 1.3.15 of the CLI was released on 6 August 2025.

This release has the following changes:

- Updates to support the new region in Montreal, Canada (`ca-mon`).
- Remediates vulnerabilities.

## Version 1.3.14
{: #cli-change-logv1-1314}

Version 1.3.14 of the CLI was released on 09 June 2025.
...
Version 1.3.13 of the CLI was released on 8 January 2025.
...
Version 1.3.12 of the CLI was released on 21 November 2024.

This release has the following changes:

- Remediates vulnerabilities.
- Updates the information messages.

## Version 1.3.11
{: #cli-change-logv1-1311}

Version 1.3.11 of the CLI was released on 23 September 2024.
...
## Version 1.3.10
{: #cli-change-logv1-1310}

Version 1.3.10 of the CLI was released on 6 August 2024.
...
- Improves the error message for the [`ibmcloud cr va-version-set`](/docs/Registry?topic=Registry-containerregcli#ic_cr_va_version_set) command.
- Updates the translations.
...
- Adds the option to output several commands in JSON format by using `--output json` or `-o json`.
