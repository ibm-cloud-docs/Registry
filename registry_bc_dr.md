...
# Understanding business continuity and disaster recovery for {{site.data.keyword.registryshort_notm}}
{: #bc-dr}
...
## Responsibilities when using {{site.data.keyword.registryshort_notm}}
