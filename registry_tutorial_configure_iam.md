...
- Ensure that you have the most recent container-registry plug-in, see [Updating the container-registry plug-in](https://console.bluemix.net/docs/services/Registry/registry_setup_cli_namespace.html#registry_cli_update).
