...
## Getting started with Container Registry
{: #sitemap_getting_started_with_container_registry1}
...
## About Container Registry
{: #sitemap_about_container_registry1}
...
## Container Registry architecture and workload
{: #sitemap_container_registry_architecture_and_workload1}
...
## What are containers?
{: #sitemap_what-are-containers?1}

[What are containers?](https://www.ibm.com/topics/containers){: external}


## Notifications
{: #sitemap_notifications1}
...
## Container Registry and Vulnerability Advisor workflow tutorial
{: #sitemap_container_registry_and_vulnerability_advisor_workflow_tutorial1}
...
## Granting access to Container Registry resources tutorial
{: #sitemap_granting_access_to_container_registry_resources_tutorial1}
...
## Setting up the {{site.data.keyword.registryshort}} CLI and namespace
{: #sitemap_setting_up_the__cli_and_namespace1}
...
## Setting up {{site.data.keyword.registryshort}} as a private registry on {{site.data.keyword.redhat_openshift_notm}}
{: #sitemap_setting_up__as_a_private_registry_on_{{sitedatakeywordredhat_openshift_notm1}}}
...
## Adding images to your namespace
{: #sitemap_adding_images_to_your_namespace1}
...
## Cleaning up your namespaces
{: #sitemap_cleaning_up_your_namespaces1}
...
## Managing quota limits for storage and pull traffic
{: #sitemap_managing_quota_limits_for_storage_and_pull_traffic1}
...
## Managing image security with Vulnerability Advisor
{: #sitemap_managing_image_security_with_vulnerability_advisor1}
...
## Setting up Terraform for Container Registry
{: #sitemap_setting_up_terraform_for_container_registry1}
...
## Formatting and filtering the CLI output
{: #sitemap_formatting_and_filtering_the_cli_output1}
...
## High availability and disaster recovery
{: #sitemap_high_availability_and_disaster_recovery1}
...
## Understanding your responsibilities
{: #sitemap_understanding_your_responsibilities1}
...
## Frequently asked questions (FAQs)
{: #sitemap_frequently_asked_questions_faqs1}
