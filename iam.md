...
| Writer | The Writer role can edit information. | Build, push, delete, and restore images.</br></br>View quotas.</br></br>Sign images.</br></br>Add and remove namespaces.</br></br>Clean up your namespaces by retaining only images that meet your criteria. (You must also have the Reader role.)</br></br>Set retention policies.</br></br>Delete all untagged images in your {{site.data.keyword.registrylong_notm}} account. |
