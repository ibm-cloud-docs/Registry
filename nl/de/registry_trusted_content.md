...
Durch Verwendung von `docker trust`-Befehlen können Sie anzeigen, wer die Images signiert hat, und auch den Status für vertrauenswürdige Inhalte widerrufen. Um `docker trust`-Befehle ausführen zu können, benötigen Sie Docker 17.12 oder höher.
{:shortdesc}
...
2.  Entfernen Sie alle vertrauenswürdigen Metadaten für das Image-Repository. Geben Sie in die Eingabeaufforderung die Kennphrase Ihres Repository-Schlüssels ein. **Optional**: Geben Sie einen Tag an, um vertrauenswürdige Metadaten nur für diese Version des Image zu widerrufen.
...
3.  Überprüfen Sie, ob die Vertrauensbeziehung in der Liste der vertrauenswürdigen Inhalte widerrufen wurde. **Optional**: Schließen Sie den Tag ein, wenn widerrufener Inhalt für ein getaggtes Image überprüft werden soll.
...
2.  Der Repository-Eigner muss den Schlüssel des Unterzeichners zum Repository hinzufügen.
    ...
    a. [Umgebung für vertrauenswürdige Inhalte einrichten](#trustedcontent_setup)
