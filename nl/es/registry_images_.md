...
- [Cree un clúster
y utilice esta imagen para desplegar un contenedor](/docs/containers?topic=containers-container_index#container_index) al clúster en {{site.data.keyword.containerlong_notm}}.
