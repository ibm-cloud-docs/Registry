...
映像檔名稱是 <strong>Repository</strong> 及 <strong>Tag</strong> 直欄的內容組合，格式為 `repository:tag`。
{:tip}
...
將從 [IBM Passport Advantage Online for customers ![外部鏈結圖示](../../icons/launch-glyph.svg "外部鏈結圖示")](https://www.ibm.com/software/passportadvantage/pao_customer.html) 下載，並包裝以與 Helm 搭配使用的 IBM 軟體，匯入到您的專用登錄名稱空間。
