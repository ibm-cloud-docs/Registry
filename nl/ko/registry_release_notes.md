...
<dl>
  ...
  자세한 정보는 [지역](/docs/services/Registry?topic=registry-registry_overview#registry_regions)을 참조하십시오.</dd>
</dl>
...
<dl>
  ...
  자세한 정보는 [조직 면제 정책 설정](/docs/services/Registry?topic=va-va_index#va_managing_policy)을 참조하십시오.</dd>
</dl>
