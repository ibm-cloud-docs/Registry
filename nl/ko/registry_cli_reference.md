...
{: caption="표 1. <codeibmcloud cr image-list</code> 명령에서 사용 가능한 필드 및 데이터 유형" caption-side="top"}
...
{: caption="표 2. <codeibmcloud cr image-inspect</code> 명령에서 사용 가능한 필드 및 데이터 유형" caption-side="top"}
...
|`Healthcheck`|오브젝트|컨테이너가 올바르게 작동하고 있는지 확인하는 방법에 대해 설명합니다. [Healthcheck](registry_cli_reference.html#healthcheck)의 필드 세부사항을 참조하십시오.|
...
{: caption="표 6. <codeibmcloud cr token-list</code> 명령에서 사용 가능한 필드 및 데이터 유형" caption-side="top"}
