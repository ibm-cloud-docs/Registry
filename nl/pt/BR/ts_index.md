...
- Instale o plug-in da CLI `container-registry`. Consulte [Instalando o plug-in da CLI `container-registry`](/docs/services/Registry/registry_setup_cli_namespace.html#registry_cli_install).
