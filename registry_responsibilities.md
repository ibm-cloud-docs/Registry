...
| Update package versions. | | It is your responsibility to update package versions inside container images. You can use Vulnerability Advisor to identify the required updates. For more information, see [Managing security with Vulnerability Advisor](/docs/Registry?topic=va-va_index). |
{: row-headers}
