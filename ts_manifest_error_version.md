...
# Why am I getting this manifest error when I try to tag my image: `The manifest version for this image is not supported for tagging.`?
{: #troubleshoot-manifest-error-version}
{: troubleshoot}
{: support}

You get a manifest version error when you try to tag your image in {{site.data.keyword.registrylong}}.
{: shortdesc}
