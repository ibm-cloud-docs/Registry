...
Import IBM software and package it for use with Helm in your {{site.data.keyword.registrylong_notm}} private registry namespace *`bluebird`*, where the path to the compressed file is *`downloads/compressed_file.tgz`*.
