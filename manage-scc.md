...
All of the goals for {{site.data.keyword.registryshort}} are added to the {{site.data.keyword.cloud_notm}} Control Library profile, but can also be mapped to other profiles.
{: note}
